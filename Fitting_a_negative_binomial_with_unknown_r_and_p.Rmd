...
```{r}
alpha = trueR = 300; ## Try 3, 30 and 300.
N = 1000
mu = 100
beta = mu/alpha
trueP = 1/(beta+1)
...
qqplot(data1, data2,
       xlab="rnbinom sample",
       ylab="2-stage Poisson-gamma sample")
abline(a=0,b=1)
title(paste0("true r = ", trueR))
...
This is the "Empirical" step of Empirical Bayes: estimating the "hyperparameters" $p$ and $r$.
...
title(paste0("true r = ", trueR,
             "\nT=true means, H=posterior means"))
```
